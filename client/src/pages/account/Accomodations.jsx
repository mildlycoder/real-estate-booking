  ...
  return (
    <section className='p-5'>
        ...
        }
        {
            (action === 'new')&&
            <section>
                <form className='flex flex-col gap-2 mx-auto w-[90%] md:w-[60%]'>
                ...
                <div>
                   ...
                   <div className='flex gap-2'>
                    ...
                    <div className='flex flex-wrap m-5'>
                        ...
                        <label className='min-h-[200px] rounded-md border-[2px] border-gray-300 border-dashed md:w-[33%] m-2 flex items-center justify-center gap-2 text-2xl text-gray-400'>
                ...
                <div className='text-xl flex gap-2' value={perks} onChange={e => setPerks(e.target.value)}>
